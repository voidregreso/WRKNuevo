...
def extract_lib_objects(lib_path, output_dir):
    ...
    result = subprocess.run(['D:/ros_y_win/WindowsResearchKernel-WRK/tools/amd64/lib.exe', '/LIST', lib_path], capture_output=True, text=True)
    ...
    for obj_file in obj_files:
        ...
        extract_result = subprocess.run(['D:/ros_y_win/WindowsResearchKernel-WRK/tools/amd64/lib.exe', '/EXTRACT:' + obj_file, lib_path, '/OUT:' + obj_output_path], capture_output=True, text=True)
